...
// Updated handleDownloadPdf to return a boolean indicating success
  const handleDownloadPdf = async (showAlert = false) => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-45px)] bg-[#ffffff] overflow-hidden relative">
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className={`px-5 py-1.5 rounded-[4px] text-[13px] font-medium transition-colors ${
                  pageSize === '2inch' 
        ...
        <div className="flex-1 bg-[#fbfbfe] overflow-y-auto p-8 flex justify-center border-l-4 border-[#4F46E5]/10">
          ...
          >
            ...
            <div className="w-full mb-1">
              <PrintDashedLine />
              <div className="flex w-full py-1 font-bold" style={{ fontSize: `${customization.tableHeadingsFontSize}px` }}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <button 
                    ...
                    className={`w-[32px] h-[32px] flex items-center justify-center border-[1.5px] rounded-[6px] font-bold text-[14px] transition-colors ${
                      customization.headerCompanyNameB ? 'border-[#4F46E5] text-[#4F46E5] bg-indigo-50' : 'border-[#4F46E5] text-[#6b7280] hover:border-[#4F46E5] hover:text-[#4F46E5]'
                    }`}
                  >
                    B
                  </button>
                  <button 
                    ...
                    className={`w-[32px] h-[32px] flex items-center justify-center border-[1.5px] rounded-[6px] font-bold text-[14px] underline transition-colors ${
                      customization.headerCompanyNameU ? 'border-[#4F46E5] text-[#4F46E5] bg-indigo-50' : 'border-[#4F46E5] text-[#6b7280] hover:border-[#4F46E5] hover:text-[#4F46E5]'
                    }`}
                  >
                    U
                  </button>
