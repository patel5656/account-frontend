        ...
        <div className="flex flex-col gap-4">
          {displayedProducts.length > 0 ? (
            displayedProducts.map((product) => (
              <div key={product.id} className="bg-white border border-gray-200 rounded-[3px] p-4 shadow-sm flex flex-col gap-3">
                {/* Product Info Row */}
            ...
            <div className="p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5 mt-1">
                ...
                <select 
                  ...
                  className="w-full h-[36px] border border-gray-300 rounded-[3px] px-2.5 text-[13.5px] outline-none text-gray-700 bg-white focus:border-[#17a2b8]"
                >
