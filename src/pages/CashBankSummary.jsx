...
export function CashBankSummary() {
  ...
  const dateLabel = dateRange === 'Last 7 Days' ? '17-May-2026 to 23-May-2026'
    : dateRange === 'Last 15 Days' ? '09-May-2026 to 23-May-2026'
    : dateRange === 'This Month' ? '01-May-2026 to 23-May-2026'
    : '01-Apr-2026 to 23-May-2026';
          ...
          <div className="bg-[#4F46E5] px-4 py-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button onClick={() => setShowPreview(true)}
                className="flex items-center gap-1.5 bg-[#17a2b8] hover:bg-[#138496] text-white px-2.5 py-1.5 rounded-[3px] text-[13px] font-bold transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between items-end px-1">
                  ...
                  <span className="text-[13px] font-bold text-[#4F46E5]">({dateLabel})</span>
                </div>
                <select
                  value={dateRange}
