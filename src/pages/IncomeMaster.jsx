...
import { IncomeMasterModal } from '../components/IncomeMasterModal';

export function IncomeMaster() {
  ...
  const handleExport = () => {
    if (rows.length === 0) {
      const headers = ['#', 'Income Name', 'Income Head'];
      ...
      link.href = url;
      link.setAttribute('download', 'income_master.csv');
    ...
    <div className="bg-[#f4f6f9] min-h-[calc(100vh-45px)] flex flex-col p-3 relative">
      <div className="bg-white rounded shadow-sm border border-gray-200 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-[#4F46E5] px-4 py-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <h2 className="text-white text-[16px] font-medium tracking-wide">Income Details</h2>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setMergeModalOpen(false)}>
          ...
          >
            <div className="bg-[#4F46E5] px-4 py-3 flex items-center justify-between">
              <h3 className="text-white font-medium text-[15px]">Income Correction</h3>
            ...
            <div className="p-5 flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-bold text-gray-800">Incorrect Income Name</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-bold text-gray-800">Correct Income Name</label>
