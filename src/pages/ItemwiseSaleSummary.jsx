...
export function ItemwiseSaleSummary() {
  ...
  return (
    <div className="bg-[#f4f6f9] min-h-[calc(100vh-45px)] p-3 flex flex-col relative pb-[70px]">
            ...
            <div className="flex flex-col sm:flex-row flex-1 gap-4 sm:gap-6">
              ...
              <div className="flex flex-col gap-1 w-full sm:max-w-[400px]">
                ...
                <input 
                  ...
                  className="w-full h-[32px] border border-gray-300 rounded-[3px] px-3 text-[13px] outline-none text-gray-700 bg-white placeholder-gray-400"
                />
              </div>
            </div>
      ...
      {/* Footer Buttons */}
      <div className="absolute bottom-0 left-0 right-0 bg-transparent p-3 flex justify-end items-center gap-2 pr-6">
        <button 
          onClick={() => navigate(-1)}
