  ...
  return (
    <div className="bg-[#f4f6f9] min-h-[calc(100vh-45px)] p-4 flex flex-col relative pb-[80px]">
      ...
      <div className="bg-white rounded shadow-sm border border-gray-200 w-full overflow-hidden flex-1">
        ...
        <div className="p-4 w-full">
          <div className="table-scroll w-full overflow-x-auto">
            ...
            <tbody>
              {/* Total Row */}
              <tr className="bg-[#a8e6cf] bg-opacity-40">
                <td className="py-3 px-2 border border-black text-[13px]"></td>
                <td className="py-3 px-2 border border-black text-[13px]"></td>
                <td className="py-3 px-2 border border-black text-[13px]"></td>
                <td className="py-3 px-2 border border-black text-[13px] font-bold text-white uppercase text-center" style={{ backgroundColor: '#80ced6'}}>Total</td>
                <td className="py-3 px-2 border border-black text-[13px] font-bold text-white text-center" style={{ backgroundColor: '#80ced6'}}>0</td>
                <td className="py-3 px-2 border border-black text-[13px]"></td>
                <td className="py-3 px-2 border border-black text-[13px]"></td>
                <td className="py-3 px-2 border border-black text-[13px] font-bold text-white text-center" style={{ backgroundColor: '#80ced6'}}>0</td>
                <td className="py-3 px-2 border border-black text-[13px] font-bold text-white text-center" style={{ backgroundColor: '#80ced6'}}>0</td>
      ...
      <div className="sticky bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-gray-200 p-2 sm:p-3 footer-btns">
        ...
        <button className="bg-[#007bff] hover:bg-[#0069d9] text-white text-[13px] font-medium px-4 py-1.5 rounded-[3px] flex items-center justify-center gap-1.5 shadow-sm transition-colors">
