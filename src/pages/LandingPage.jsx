          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingPlans.map((plan, i) => (
              <motion.div 
                ...
                style={{ transformStyle: "preserve-3d", perspective: 1000 }}
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
                className={`bg-white border rounded-xl p-6 flex flex-col justify-between shadow-sm transform-gpu cursor-pointer transition-all duration-200 ${
                  selectedPlan === i
              ...
              >
                <div className="space-y-4" style={{ transform: "translateZ(20px)" }}>
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-extrabold text-gray-900">{billingPeriod === 'monthly' ? plan.monthlyPrice : plan.yearlyPrice}</span>
                    <span className="text-[11px] text-gray-555">/ mo</span>
                  </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-400 text-sm leading-relaxed">
                    123 Business Avenue, Tech Park,<br />New Delhi, India 110001
                  </span>
                </li>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-slate-400 text-sm">support@osbooks.com</span>
                </li>
              </ul>
            </div>
