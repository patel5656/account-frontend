    ...
    if (isOpen) {
      ...
      const fetchProducts = async () => {
        try {
          ...
          console.error('Failed to fetch products for BOM dropdown:', err);
        }
      };
      fetchProducts();
                ...
                <div className="col-span-2 flex flex-col gap-1">
                  ...
                  <div className="flex gap-1">
                    ...
                    <select 
                      ...
                      className="w-2/3 border border-gray-300 rounded-[3px] px-1 py-1.5 text-[13px] outline-none focus:border-blue-500 bg-white"
                    >
