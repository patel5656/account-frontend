...
export function BomMasterModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-[3px] shadow-2xl w-full max-w-[min(98vw,800px)] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
        
        {/* Header */}
        <div className="bg-[#4F46E5] flex items-center justify-between">
          <h2 className="text-[15px] text-white font-medium tracking-wide pl-4 py-2.5">Create BOM Master</h2>
          <button 
            onClick={onClose} 
        ...
        <div className="p-4 bg-white">
          <div className="flex flex-col gap-4">
            ...
            <div className="border border-gray-200 rounded-[3px]">
              <div className="grid grid-cols-12 gap-2 p-2 border-b border-gray-200 bg-gray-50 text-[13px] font-bold text-gray-700">
              ...
              <div className="grid grid-cols-12 gap-2 p-2 border-b border-gray-200 items-center">
                <div className="col-span-1 text-center text-[13px] text-gray-500"></div>
                <div className="col-span-4">
                  <select className="w-full border border-gray-300 rounded-[3px] px-2 py-1.5 text-[13px] outline-none focus:border-blue-500">
                    <option value="">Select Product</option>
                  </select>
                </div>
                <div className="col-span-2 flex gap-1">
                  <input type="text" defaultValue="1" className="w-1/3 border border-gray-300 rounded-[3px] px-2 py-1.5 text-[13px] outline-none focus:border-blue-500 text-right" />
                  <select className="w-2/3 border border-gray-300 rounded-[3px] px-2 py-1.5 text-[13px] outline-none focus:border-blue-500">
                    <option value="Units">Units</option>
                  </select>
                </div>
                <div className="col-span-1">
                  <input type="text" defaultValue="0" className="w-full border border-gray-300 rounded-[3px] px-2 py-1.5 text-[13px] outline-none focus:border-blue-500 text-right" />
                </div>
                <div className="col-span-1">
                  <input type="text" defaultValue="0" className="w-full border border-gray-300 rounded-[3px] px-2 py-1.5 text-[13px] outline-none focus:border-blue-500 text-right" />
                </div>
                ...
                <div className="col-span-1 flex justify-center">
                  <button className="bg-[#007bff] hover:bg-[#0069d9] text-white px-3 py-1.5 rounded-[3px] text-[13px] font-medium transition-colors">
                    Add
                  </button>
                </div>
              </div>
