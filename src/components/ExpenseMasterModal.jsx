...
export function ExpenseMasterModal({ isOpen, onClose }) {
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-[3px] shadow-2xl w-full max-w-[min(96vw,600px)] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="bg-[#4F46E5] flex items-center justify-between">
          <h2 className="text-[15px] text-white font-medium tracking-wide pl-4 py-2.5">Expenses Master</h2>
          <button 
            onClick={onClose} 
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-[1fr_auto] gap-4">
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                <select className="w-full border border-gray-300 rounded-[3px] px-3 py-[9px] text-[14px] outline-none focus:border-[#4F46E5] text-gray-500 bg-white">
                  <option>Enter Expense Head</option>
                </select>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1 w-[250px]">
              ...
              <select className="w-full border border-gray-300 rounded-[3px] px-3 py-[9px] text-[14px] outline-none focus:border-[#4F46E5] text-gray-800 bg-white">
                <option>Operating Expenses</option>
                <option>Non-Operating Expenses</option>
